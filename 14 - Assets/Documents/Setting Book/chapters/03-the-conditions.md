...
They are the world's archivists, judges, notaries, and living libraries. Courts, guilds, and archives are built around them. Too many deathless people and institutions would go rigid, so their scarcity is part of the world's shape. They are consulted, and a little apart.
...
The Bound are the only Conditioned who chose it. In some extremity they swore a contract with something on the other side, and got power in exchange for Terms (the standing obligations written into the contract). The horror is contractual, not infernal: a debt and a counterparty (the other party to the contract) that always watches the ledger. This is distinct from Infernis, Daggerheart's demon-blooded *ancestry*. Bound is acquired, never born.
...
The Pledge was chosen up front, at the signing. You knew what you would owe. So the loss is both grief and gift: the hole is also an immunity. People are not afraid of the Unbound. They are unsettled by the absence in them. Where the Long-Lived must keep learning to stay whole, the Unbound must keep connecting to stay quiet: opposite fuels.
...
The Gaze, their stilling look, can hold a moment still: a bleeding wound stops bleeding, a spreading poison stops spreading, a blade already swinging hangs a beat too long. Peacekeepers want them on a riot line. A stilled brawl is a brawl that didn't turn into a massacre. Surgeons and medics want them in the theatre: a patient held perfectly still is a patient who survives the knife. They are feared and licensed rather than revered, because the same Gaze that stops a wound bleeding can, misused or lost to anger, hold a person still forever. Licenses, oversight, and a strict code govern who may still and why.
...
At Leaf-Fall, an Answered child's leaf marks them Given, and its **shade** names which element answered: **Ember** (fire), **Tide** (water), **Root** (earth and stone), or **Gale** (air). From that day the element is theirs to speak to, not summon or command, coaxed like clay, never conjured like a spirit.
...
Which element answers, and what temperament came with it, is different every time. An even-tempered Root-Answered potter and a short-fused Ember-Answered smith have nothing in common but the name. Some guilds prize them above any other artisan. Some households are wary of hosting one whose element runs hot. The leaf-shade names the element; it does not tell you which kind of person you are getting until you meet them. That is why "wildcard" sticks as a label.
...
There is no Struck door. An element answers at the Awakening, or it does not. This is not a bargain, the way the Bound swore a contract with a counterparty.
...
Their work *is* their upkeep. A life spent on soil, among growing things, under open sky keeps the green in them fed without a thought. The Tithe only bites when one of the Taken-In is pulled off the land: a long sea voyage, a stretch in a stone gaol, a season stuck in a walled city on a lord's business. Old frontier custom is to send them home before they wilt. City hosts who must keep one indoors learn to fill the room with potted green and open windows, courtesy that also keeps their guest from going to seed on the parlour floor.
