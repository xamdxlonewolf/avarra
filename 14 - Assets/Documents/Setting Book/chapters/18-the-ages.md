...
Ledan is asking a court question. The Speaker who answers, if they answer, will name a wood. The Vaethorn debtor will name a taking. The loan will still come due.
...
The era has no dated start. It grows out of Before the Walk when the trip becomes *the* way to Turn. It has a dated hinge: the First Cut (C.Y. 0). After that the Walking Years cease to be the *default* in lands the wood has reached, and remain the default in lands it has not. Heskoren is still, in places, *in* this era.
...
Children died on the road. So did the adults who carried them. River-crossings in the thaw, a fever in a packed Near-Mile inn, a late squall on the inner sea, hunger on a Long-Mile stretch between hearths, a birth that would not wait for the grove. Long roads kill people. That is what they do.
...
In Brenvaeth, a land far from Thaeloren was **Kept-heavy and Struck-heavy because most ten-year-olds never stood under the canopy.** That was how the world worked anywhere the walk was too far or too dear.
...
Water if the ground allows. A flat top for a pack. Often a name. Often a ribbon.
...
Spreading Trees made a queue. Struck stigma, Tithe-leverage, the pitied Kept: none of that dissolved when a second canopy opened. The new injustice is *which town next*, paid in twenty more years of borrowed Turnings. She did not write the list. People did.
...
Three stacked frictions, none of them unworthiness:
...
"We will not write who" is the capture. "The soil is thin" is already a list. The pots on the verso are the argument the recto pretends to have closed. Folk who keep the nameless knife think this paper is a confession. The Seat thinks it is competence. Both can hold the same copy.
...
Many deathless houses began as road-houses. That fate-shift is already in the past: inns that became banks, the same Long-Lived, a different fortune.
...
What a traveller can already see:

- The **First Seat** is old in the queue. It has authorized cuts for three hundred and eighty-seven summers. Towns that can see a neighbour's canopy have learned the horticulture-sentence by heart. Folk-right slips still happen. Threnmaieth still wants the college on the roll. The Seat is *heavy.*
