...
Because they can go where footpaths can't and read the mountain's mood before it turns, Tengu work as high-pass guides, weather-callers, sky-couriers, and mountain rescue. They carry word over the peaks faster than any road, call the avalanche warning down to the valley towns, and go over the edge after the fallen climber. Tengu settlements cling to cliff faces and ridge-shelves, reached by wing or by rope, and a Tengu's first solo flight off the home crag is as significant a coming-of-age as a Selkie child first given the run of their own skin. They keep a running, half-teasing rivalry with the Selkies. Sky-folk and sea-folk each remain convinced their element is the one worth belonging to.
