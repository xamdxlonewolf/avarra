...
| Condition | Monster | Standing | Path | ~% pop. | Status |
|---|---|---|---|---|---|
| [[Long-Lived]] | vampire | rare / revered | Given | ~2.5% | ✅ mechanics locked |
| [[Two-Bodied]] | werewolf | common | Given | ~18% | ✅ mechanics locked |
...
| Condition | Monster | Standing | Path | ~% pop. | Status |
|---|---|---|---|---|---|
| [[The Unbound]] *(colloq. the Hollow)* | the price of a contract | pitied / uneasy | Struck — **chains off [[Bound]] only** | ~1.5% | ✅ mechanics locked |
