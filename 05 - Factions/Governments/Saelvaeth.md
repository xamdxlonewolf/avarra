...
note_status: stub
status: active
tags: [faction, government, polity, heskoren, epic-7, live-front]
...
Town-wardens, borrowed Turnings, Road-hands who sleep here on the way to a town that was not chosen. Recruits not by Kind. [[The Old Ways]] are neighbours ([[Vaelhesk]]), not a museum. Vaethorn heat sits on many hearths as gospel, not always as flag.

## Goals & Methods

Keep taken grafts alive. Host the neighbour's week. Argue the next pot. Survive being the sentence the Seat already wrote.
