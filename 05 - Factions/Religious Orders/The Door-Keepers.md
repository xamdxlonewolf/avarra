---
title: The Door-Keepers
type: faction
visibility: player
note_status: fleshed
status: active
tags: [faction, religious-order, clergy, door-keepers, old-ways, vaeloren, epic-5]
aliases: [Door-Keepers, Door-keepers, Kin-Speakers, Kin-speakers, The Vaelbren, Vaelbren, The Green Kin]
world: The Turning
...
- **No Road-hand, no queue, no Speaking.** They do not carry scions. They do not confirm colours. They do not authorise a cut. When a graft sickens in an old green, they argue *host*, not horticulture. The [[The Tree-Wardens|Road-hands]] already walk the other job.
- **A land-and-kin house, not a druid-chapter.** They do not police the Mother-name. Many also bring a child to a healthy graft. The ~5% dial stays at the contested grove and the unvouched Struck — not at a holy war in the trees.
...
**Not by Kind.** A [[Tengu]] ridge-child and a human neighbour walk the same stone if they know it and will stand for kin. Vaeloren has no crow-chapter, no Taken-In-only grove-guard. The Taken-In are *revered* here; they are not a membership test. That rule is load-bearing ([[Kinds of the Turning]]).
...
| Ancestor-meals | anyone of the house | the dead stay in the ground — not [[Returned\|the Returned]]'s door | a Returned guest is a *different* door; do not make the Kin-speaker their priest |
...
- **[[Polity Archetypes|Vaethorn]] (the door-folk).** Home weather, and the live fight. The warden *is* most of the state; the door-keeper is the older state the land still keeps. Guest-reading towns that finally got a Tree did not throw their grandparents out of the rite — they pilgrimage *and* walk. First-reading districts still waiting on a scion that will not take tend a dying guest and refuse the blessing. Vaethorn's guilt-theology (scarcity read as unworthiness) is the enemy, not the Hands-folk hearth. A closed door is weather.
- **[[Polity Archetypes|Lestrand]] (grove-talkers).** A frontier curiosity. A door-keeper on the docks is a migrant or a story. The Settling will stamp a Struck's terms and call the kin-name poetry. Useful, if someone needs a drowning-stone found. Not a rival for the quay.
- **[[Polity Archetypes|Threnmaieth]] (the Unreached).** Filed as a gap: people who were not at a proper Tree, doors the roll cannot name. A Kin-speaker in the core is rare and interesting to a crown-archivist. The census wants a column. The land is not a column. Pressure, not a hunt.

## The host of a dying guest (the order's injustice)
...
*Left tied to an ailing graft in an old Taken-In green, the week a Road-hand's cart was seen at the ford. Two hands; one knife-cut for the string. `oblique-worldbuilding`.*
...
On its face: frontier courtesy, a little barbed — the drowning-stone saying reused as a note on a trunk. Underneath: the house's whole case, and the seam they cannot see. They have correctly felt that becoming happens at doors with no healthy Tree. They have not asked whether a hand was in the water too, at the end of its reach. The Road-hand who eats first will plant as a guest. The one who cuts without the meal will be remembered as a claiming, and the wood may still take.
...
- **Taste still open (do not treat as locked).**
  ...
  2. **Two jobs, often one mouth.** Proposed. The other clean option: *door-keeper* is the only everyday word, and *Kin-speaker* is what you are called at the meal.
