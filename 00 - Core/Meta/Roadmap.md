...
- **Atlas follow-up:** 8 / 8 regional sheets rebuilt and visually reviewed ✅ **2026-09-01.** Sacred Core, Rain-Wall, Chart-run, and West Water are deterministic 1344 × 896 parent windows via `build_prototype3_regions.py` (atlas scale; local close-ups rejected). Region-parent provenance and the non-canon interpolation boundary are recorded on [[The Atlas Sheets]] and [[Map Generation Tooling]]. Thaeloren remains the only exceptional Tree. World book untouched.
