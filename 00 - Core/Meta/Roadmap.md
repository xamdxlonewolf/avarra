...
|---|------|--------------------|:---:|:---:|
| **R** | [[#Epic R: Editorial repair and table readiness]] | Clears every actionable finding in the full editorial audit before new canon is built | **High** | 🔴 active next — Story R.12 (R.13 ✅) |
...
**Source:** [[Editorial Audit 2026-08-29]] · **Status:** 🔴 **active next — Story R.12** · **Blast radius:** High. Stories R.1–R.11 and **R.13** ✅.
...
- [x] Move seeds, story numbers, canon emoji, "do not clone," and similar production scaffolding out of player-facing bodies — power stubs, seats, leftovers, gazetteer, Kind Heritage, People hub; R.12 still owns voice/phonology
...
## Epic 8 — People
**Skill:** `character-arc`, `character-naming`, `positional-revelation`, `perspectival-constellation` · **Status:** 🟢 **8.1 landed in Story R.8 (2026-08-30).** Hub [[People of the Turning]]. Offices named as furniture are people now. Do not rebuild the seats. Do not rebuild the squares. Next in Epic R is R.12.
