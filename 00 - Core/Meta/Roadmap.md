...
## Epic 7 — Settlements
**Skill:** `settlement-design` · **Status:** 🟢 **Story 7.1 done (2026-08-24).** Specific places, built on Epics 2–6. Residue types already on the ground → [[Settlement Seeds]]. Named powers → [[Powers of the Turning]]. Do not rebuild the era spine. Do not treat Ornthael as post-history.
...
- [x] 🟡 Count and place — **15** = 3 worked corners + 12 stubs; [[Maiethorn]] 6 · [[Strandoren]] 5 · [[Heskoren]] 4; [[The Sundering Isle|Kumbaan]] not a thirteenth mainland power
- [x] 🟡 Names from [[The Old Tongue]] + stance-drift (seed `20260827`; pick from the middle). Conservative Motherland · worn Heskoren · eroded Strandoren. How a power sounds reveals stance
- [x] 🟡 Un-built corners now stubbed — **[[Maiethvael]]** (devout rich light-state) · **[[Trenledd]]** (surveillance, no hymn) · **[[Ornled]]** (secular frontier, required on Heskoren)
...
- [x] 🟡 Hub + twelve stub notes in `05 - Factions/Governments/`. Capitals, districts, populations **not** named (7.2–7.3). Do not capture the [[The Tree-Wardens|First Seat]]. Do not make [[Harrow's Green]] a capital
...
Flesh a few settlements from [[Settlement Seeds]] (not all nine types). Tree-at-the-centre grammar from [[Daily Life]]; two clocks visible; one leftover job per street. Polity-face from [[Powers of the Turning]]. Do not clone Road-hands, the Slide, or Kind-quarters. Do not rebuild 7.1.
...
- **Epic 7 — Settlements:** 🟢 **Story 7.1 done (2026-08-24).** 6 / 6 of 7.1. Hub [[Powers of the Turning]] · twelve stubs ([[Maiethvael]] · [[Orenbren]] · [[Saelthael]] · [[Eolstrand]] · [[Lirorn]] · [[Brenledd]] · [[Leddvael]] · [[Trenledd]] · [[Netstrand]] · [[Ornled]] · [[Vaelhesk]] · [[Saelvaeth]]). 15 = 6 Maiethorn + 5 Strandoren + 4 Heskoren. Kumbaan not a thirteenth. Un-built corners stubbed. Names 🟡 (seed `20260827`). **⭐ Next: Story 7.2 — playable squares from leftover types.**
