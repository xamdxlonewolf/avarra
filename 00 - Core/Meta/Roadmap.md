...
| **A** | [[#Epic A — Atlas labels]] | Overlay names on the selected paintings, one sheet per story | Low | A.1–A.5 + A.7 done; A.6 next |
...
## Epic A — Atlas labels
**Skill:** vault geography ([[Named Ground]] · [[The Known Map]]) · **Status:** 🟢 **A.1–A.5 + A.7 done (2026-09-16); A.6 and A.8–A.13 queued, one sheet per session** · **Blast radius:** Low. Table aids only. Does not reopen R.10, invent gazetteer, or touch the world book.
...
- **Epic A — Atlas labels:** 5 / 5 of A.1 (100%) ✅ **2026-09-01.** 4 / 4 of A.2 (100%) ✅ **2026-09-03.** 4 / 4 of A.3 (100%) ✅ **2026-09-16.** 4 / 4 of A.4 (100%) ✅ **2026-09-16.** 4 / 4 of A.5 (100%) ✅ **2026-09-16.** 4 / 4 of A.7 (100%) ✅ **2026-09-16.** Overlay method locked. A.7 was completed out of order at user direction; A.6 and A.8–A.13 remain queued, one sheet per session. Next unchecked: **A.6 Old Crossing (R1).** World book untouched.
