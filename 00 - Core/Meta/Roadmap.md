...
|---|------|--------------------|:---:|:---:|
| **R** | [[#Epic R: Editorial repair and table readiness]] | Clears every actionable finding in the full editorial audit before new canon is built | **High** | 🔴 active next — Story R.11 |
...
**Source:** [[Editorial Audit 2026-08-29]] · **Status:** 🔴 **active next — Story R.11** · **Blast radius:** High. Stories R.1–R.10 ✅. Do not start R.11 until asked.
...
> **R.8 recorded decisions.** Offices became people; seats were not rebuilt. Two clocks: Thilim and Laevila walked (different jobs of *I walked*); Mataero thinks the wave is over; Vaethod still sends; live front pointed at Haelin, not cloned. Seeds are mouths, not factions. Given-Over broker and Threnmaieth instrument-set landed in R.7. World book untouched. Stories R.9–R.10 ✅. **Next: Story R.11.** Do not start it until asked.
...
> **R.10 recorded decisions.** Common-tongue first. No new liturgy (R.12 still owns phonology). Kumbaan never. Inner Close stays in Orenbren. Fifteen still fifteen. SVG = placement; paintings = terrain feel; world-sheet extra isles are not canon. World book untouched. **Next: Story R.11.** Do not start it until asked.
