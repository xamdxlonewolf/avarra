...
| **7** | [[#Epic 7 — Settlements]] | Concrete stages for play | Med | 🟢 7.1 done |
...
## Epic 7 — Settlements
**Skill:** `settlement-design` · **Status:** 🟢 **Story 7.1 done and 🔒 (2026-08-24, user-approved).** Specific places, built on Epics 2–6. Residue types already on the ground → [[Settlement Seeds]]. Named powers → [[Powers of the Turning]]. Do not rebuild the era spine. Do not treat Ornthael as post-history.

> Progressive elaboration from Story 6.4. **Story 7.2 is task-sketched for the next session.** Named stubs already implied (Harrow's · the three hamlets · Third Hearth · White Note) stay seeds until 7.2 fleshes a square. Do not rebuild 7.1.
...
- [x] 🟡 Hub + twelve stub notes in `05 - Factions/Governments/`. Capitals, districts, populations **not** named (7.2–7.3). Do not capture the [[The Tree-Wardens|First Seat]]. Do not make [[Harrow's Green]] a capital. Stub *texture* stays polishable; the **names and placement are 🔒**.
...
- [ ] 🟡 Pick **3–4 types**, not nine. Include **at least one already-named stub** to flesh ([[Harrow's Green]] / [[The Three Hamlets Past the Ford]] / [[The Third Hearth]] / [[The White Note House]]) **and at least one new square** from an unused type (origin pilgrimage-town · road-end Tree-town · salt quay · sick-Tree square · guest-grove · Rain-Shadow walk-hold)
- [ ] 🔒 Tree at the centre ([[Daily Life]]); **two clocks visible** (a road that used to go further / a stone / an upper room / a wait); **one leftover job per street** (devotion / prestige / necessity — not all three as the town's theme)
- [ ] 🟡 Polity-face from [[Powers of the Turning]], not only the three corners. Do not make [[Harrow's Green]] a capital. Do not capture the [[The Tree-Wardens|First Seat]]
- [ ] 🔒 Hearths not Kind-quarters ([[Kinds of the Turning]]). Do not clone Road-hands or [[The Slide]] as a district
- [ ] 🟡 `settlement-design` at square scale (site, leftover, one tension) — not a full district grid. Names from [[The Old Tongue]] + the power's drift (seed recorded)

*Suggested mix (taste-open, not locked):* flesh [[Harrow's Green]] + the hamlets (live front, already on the ground) · one deathless leftover ([[The Third Hearth]] or [[The White Note House]]) · one new square that proves Clock 2 is not “the frontier” (Rain-Shadow walk-hold on [[Saelthael]], or a sick-Tree square in the core).

### Story 7.3 — The three archetype seats
Vaethorn / Lestrand / Threnmaieth as *places* (not only corners). Neighbours now named ([[Maiethvael]] · [[Orenbren]] · [[Brenledd]] · [[Saelvaeth]], etc.). Do not let Threnmaieth capture the First Seat in the first sentence. Do not rebuild 7.1.
