---
title: The Branch That Came Away
type: myth
visibility: player
note_status: fleshed
...
> **The teaching-story of the Cut.** Told about [[The First Cut]], and still told in towns that have a Tree and a neighbour that does not. Built as a `paradox-fable` for [[Roadmap|Story 6.3]] — sharing a Hand requires wounding a Hand, and the first copy invented both the local mercy and the wait. The bones stay the same. The last line will not choose whose hand.
...
- **Do not pick a last line in GM voice.** Which mouth an NPC offers is a faster read than a speech about Eoloren. A Road-hand who tells the clergy ending and then sleeps in the town that was not chosen has told you the office's whole job.
