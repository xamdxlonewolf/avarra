...
note_status: draft
status: active
tags: [religion, turning-tree, leaf-fall, awakening, engine, ceremony]
aliases: [The Turning Tree, Turning Trees, Hand of the Mother, The Awakening Tree, Motherwood]
world:
region:
stratum:
...
> **The engine, made concrete.** The Turning Tree is the object at the center of the world's central rite: at a child's tenth-year solstice, the town gathers and the Tree either **Gives a Condition** (a coloured leaf) or **Keeps** the child whole (a hug of leaves, no colour). This note fixes *what a Tree is, where they come from, and how the Leaf-Fall is staged.* The faith built around it lives in [[The Leaf-Mother]]; the acquisition rules it enacts are locked in [[The Premise]].

## What a Turning Tree is
...
The colour that falls tells the town which Condition has been Given. How that reading is *known* shapes the faith's institutions:
