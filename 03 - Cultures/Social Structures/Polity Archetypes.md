...
Three more corners are deliberately left un-built (a secular frontier, a devout-but-lightly-governed rich core, a cold surveillance-state with no faith to sanctify it) — they're reachable by the same knobs and get named-stubbed when [[Roadmap|Epic 3/7]] need them. Three worked examples prove the space; a fourteen-cell catalogue is pass-two work.
